...
public class SiriException extends java.lang.Exception
{
   ...
   public static enum ERROR_CODE
   {
      ...
      UNKNOWN_PARTICIPANT_ERROR,
      UNKNOWN_ENDPOINT_ERROR,
      ENDPOINT_DENIED_ACCESS_ERROR,
      ENDPOINT_NOT_AVAILABLE_ACCESS_ERROR,
      SERVICE_NOT_AVAILABLE_ERROR,
      CAPABILITY_NOT_SUPPORTED_ERROR,
      ACCESS_NOT_ALLOWED_ERROR,
      INVALID_DATA_REFERENCES_ERROR,
      BEYOND_DATA_HORIZON,
      NO_INFO_FOR_TOPIC_ERROR,
      PARAMETER_SIGNORED_ERROR,
      UNKNOWN_EXTENSIONS_ERROR,
      ALLOWED_RESOURCE_USAGE_EXCEEDED_ERROR,
